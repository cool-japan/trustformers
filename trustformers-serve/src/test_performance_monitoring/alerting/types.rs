...
pub struct NotificationDispatcher {
    ...
    pub(super) dispatch_queue: Arc<Mutex<VecDeque<NotificationRequest>>>,
    pub(super) rate_limiter: Arc<NotificationRateLimiter>,
    pub(super) template_engine: Arc<TemplateEngine>,
    pub(super) delivery_tracker: Arc<DeliveryTracker>,
    pub(super) notification_metrics: Arc<NotificationMetrics>,
}
...
pub struct ThresholdMonitor {
    ...
    pub(super) monitoring_scheduler: Arc<MonitoringScheduler>,
    pub(super) threshold_cache: Arc<Mutex<ThresholdCache>>,
    pub(super) evaluation_metrics: Arc<EvaluationMetrics>,
    pub(super) real_time_processor: Arc<RealTimeProcessor>,
}
