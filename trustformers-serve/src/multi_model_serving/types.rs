...
#[derive(Debug)]
struct RoutingState {
    _round_robin_index: usize,
    _model_weights: HashMap<String, f64>,
    _request_counts: HashMap<String, u64>,
}
...
struct EnsembleState {
    _active_ensembles: HashMap<String, EnsembleInfo>,
    _quality_scores: HashMap<String, f64>,
}
/// Performance record
#[derive(Debug, Clone)]
...
struct MultiModelState {
    ...
    _ensemble_state: EnsembleState,
    /// Performance history
    _performance_history: HashMap<String, Vec<PerformanceRecord>>,
}
/// A/B test metrics
