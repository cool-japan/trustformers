...
fn default_cbindgen_config() -> cbindgen::Config {
    ...
    config.namespace = Some("TrustformeRS".to_string());
    config.language = cbindgen::Language::C;
    config.style = cbindgen::Style::Both;
    config.cpp_compat = true;
    config.header = Some("/* TrustformeRS C API\n * High-performance transformer library\n * Generated automatically - do not edit\n */".to_string());
    config.include_guard = Some("TRUSTFORMERS_H".to_string());
    ...
    config.after_includes = Some("#ifdef __cplusplus\nextern \"C\" {\n#endif".to_string());
    config.trailer = Some("#ifdef __cplusplus\n}\n#endif".to_string());
