...
**Version:** 0.1.2 | **Status:** Alpha | **Tests:** 1 | **SLoC:** 131,187 | **Last Updated:** 2026-06-20
...
```swift
dependencies: [
    .package(url: "https://github.com/cool-japan/trustformers-ios", from: "0.1.2")
]
```
...
```gradle
dependencies {
    implementation 'com.trustformers:mobile:0.1.2'
}
```
